---
title: Dialog
description: Open a component-based modal dialog imperatively from code with
  $q.dialog, a chainable controller and OK / Cancel / Dismiss events.
navigation:
  icon: lucide:app-window
seo:
  title: Dialog ($q.dialog)
  description: $q.dialog — push a component-based modal dialog from code, with onOK / onCancel / onDismiss.
---
