---
title: Loading
description: Show a counted fullscreen loading overlay imperatively from code
  with $q.loading.
navigation:
  icon: lucide:loader-circle
seo:
  title: Loading ($q.loading)
  description: $q.loading — show/hide a counted fullscreen loading overlay.
---
