---
title: v-intersection
description: Calls a handler when an element enters or leaves the viewport, with
  shared observers and a one-shot mode.
navigation:
  icon: lucide:eye
seo:
  title: v-intersection directive
  description: v-intersection — IntersectionObserver wrapper with shared observers and a .once modifier.
---
