---
title: Row
description: A semantic alias of QGrid — the same 12-column system, reading better
  when the container is a row in your mental model.
navigation:
  icon: lucide:rows-3
seo:
  title: Row (QRow)
  description: QRow — a semantic alias of QGrid with the same 12-column system.
---
