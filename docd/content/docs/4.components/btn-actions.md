...
description: A dropdown button driven by an actions array — generated trigger and menu items.
navigation:
  icon: lucide:list-plus
seo:
  title: Button Actions (QBtnActions)
  description: QBtnActions — a dropdown button driven by an actions array (label, icon, color, description).
---
...
::prose-show-case
<dnax-demo-btn-actions demo="row"></dnax-demo-btn-actions>
...
::prose-show-case
<dnax-demo-btn-actions demo="menu"></dnax-demo-btn-actions>
...
::prose-show-case
<dnax-demo-btn-actions demo="manage"></dnax-demo-btn-actions>
