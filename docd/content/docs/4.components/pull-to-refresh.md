...
description: Pull down from the top of a scrollable container to refresh, with
  custom colors, thresholds, indicators and a controlled v-model.
navigation:
  icon: lucide:refresh-cw
seo:
  title: Pull To Refresh (QPullToRefresh)
  description: QPullToRefresh — pull down to refresh with mouse and touch.
---
