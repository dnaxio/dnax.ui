---
title: Nav Menu
description: A top navigation bar with hover/click dropdown menus, icons, custom
  triggers and accessible keyboard navigation.
navigation:
  icon: lucide:menu
seo:
  title: Nav Menu (QNavMenu)
  description: QNavMenu — a top navigation bar with dropdown menus.
---
