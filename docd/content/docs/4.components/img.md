---
title: Image
description: A responsive image container — aspect ratio, object-fit, loading
  spinner, blur-up placeholder and error slot.
navigation:
  icon: lucide:image
seo:
  title: Image (QImg)
  description: QImg — a responsive image container with ratio, object-fit, loading and error states.
---
...
::prose-show-case
<dnax-demo-img demo="basic"></dnax-demo-img>
...
::prose-show-case
<dnax-demo-img demo="loading"></dnax-demo-img>
...
::prose-show-case
<dnax-demo-img demo="placeholder"></dnax-demo-img>
...
::prose-show-case
<dnax-demo-img demo="caption"></dnax-demo-img>
...
::prose-show-case
<dnax-demo-img demo="error"></dnax-demo-img>
