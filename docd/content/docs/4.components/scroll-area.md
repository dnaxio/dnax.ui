---
title: Scroll Area
description: A scrollable region with a custom, draggable scrollbar thumb.
navigation:
  icon: lucide:scroll-text
seo:
  title: Scroll Area (QScrollArea)
  description: QScrollArea — a scrollable region with a custom draggable scrollbar thumb.
---
