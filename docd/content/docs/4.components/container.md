---
title: Container
description: A centered max-width wrapper with configurable padding or fluid mode,
  plus decorative grid, star, wave, aurora and image backgrounds.
navigation:
  icon: lucide:frame
seo:
  title: Container (QContainer)
  description: QContainer — a centered max-width container with decorative backgrounds.
---
...
::prose-show-case
<dnax-demo-container demo="basic"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="grid"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="star"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="falling"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="flicker"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="interactive"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="wave"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="aurora"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="glass"></dnax-demo-container>
...
::prose-show-case
<dnax-demo-container demo="image"></dnax-demo-container>
...
<dnax-api name="QContainer"></dnax-api>
