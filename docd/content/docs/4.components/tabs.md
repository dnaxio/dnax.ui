---
title: Tabs
description: A horizontal tab bar with a sliding indicator — align, icons,
  counts, animated transitions, collapse and route tabs.
navigation:
  icon: lucide:panel-top
seo:
  title: Tabs (QTabs)
  description: QTabs, QTab and QRouteTab — the tab bar family with the Quasar API.
---
