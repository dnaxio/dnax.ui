---
title: Count Down
description: A countdown timer from a duration or to a target date, with
  formatting tokens, an end event, controls and a raw-data slot.
navigation:
  icon: lucide:timer
seo:
  title: Count Down (QCountDown)
  description: QCountDown — a countdown timer with the Quasar API.
---
...
::prose-show-case
<dnax-demo-count-down demo="basic"></dnax-demo-count-down>
...
::prose-show-case
<dnax-demo-count-down demo="formats"></dnax-demo-count-down>
...
::prose-show-case
<dnax-demo-count-down demo="target"></dnax-demo-count-down>
...
The slot exposes `days / hours / minutes / seconds / ms / remaining / progress /
running / formatted` — build your own layout, here a progress bar.

::prose-show-case
<dnax-demo-count-down demo="slot"></dnax-demo-count-down>
...
::prose-show-case
<dnax-demo-count-down demo="controls"></dnax-demo-count-down>
...
<dnax-api name="QCountDown"></dnax-api>
