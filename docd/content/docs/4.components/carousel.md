---
title: Carousel
description: A scroll-snap carousel built on Embla — content, slides and nav buttons.
navigation:
  icon: lucide:images
seo:
  title: Carousel (QCarousel)
  description: QCarousel family — provider, viewport, slide and previous/next buttons (Embla).
---
...
::prose-show-case
<dnax-demo-carousel demo="basic"></dnax-demo-carousel>
...
::prose-show-case
<dnax-demo-carousel demo="loop"></dnax-demo-carousel>
...
::prose-show-case
<dnax-demo-carousel demo="vertical"></dnax-demo-carousel>
...
<dnax-api name="QCarousel"></dnax-api>
...
<dnax-api name="QCarouselContent"></dnax-api>
...
<dnax-api name="QCarouselItem"></dnax-api>
...
<dnax-api name="QCarouselNav"></dnax-api>
