---
title: Fab
description: A floating action button that expands a stack of actions, fixed to
  the screen edge with safe-areas.
navigation:
  icon: lucide:circle-plus
seo:
  title: Fab (QFab)
  description: QFab — a floating action button with expandable QFabAction children.
---
...
::prose-show-case
<dnax-demo-fab demo="basic"></dnax-demo-fab>
...
::prose-show-case
<dnax-demo-fab demo="positions"></dnax-demo-fab>
...
::prose-show-case
<dnax-demo-fab demo="colors"></dnax-demo-fab>
...
::prose-show-case
<dnax-demo-fab demo="actions"></dnax-demo-fab>
...
<dnax-api name="QFab"></dnax-api>

## QFabAction

<dnax-api name="QFabAction"></dnax-api>
