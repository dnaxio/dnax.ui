---
title: Input Tag
description: A text field that collects tags as chips — Enter to add, × to remove,
  editing and pasting built in.
navigation:
  icon: lucide:tags
seo:
  title: Input Tag (QInputTag)
  description: QInputTag — a tag/chips input reusing the q-input field vocabulary.
---
...
::prose-show-case
<dnax-demo-input-tag demo="basic"></dnax-demo-input-tag>
...
::prose-show-case
<dnax-demo-input-tag demo="events"></dnax-demo-input-tag>
...
::prose-show-case
<dnax-demo-input-tag demo="states"></dnax-demo-input-tag>
...
<dnax-api name="QInputTag"></dnax-api>
