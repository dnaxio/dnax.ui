---
title: Syntax
description: Code blocks with Shiki syntax highlighting, a filename bar and a
  copy button.
navigation:
  icon: lucide:code
seo:
  title: Syntax (QSyntax)
  description: QSyntax — Shiki-highlighted code blocks with filename bar and copy button.
---
