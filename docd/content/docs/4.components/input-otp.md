---
title: Input OTP
description: A one-time-password field — one box per character, numeric or masked,
  grouped and with a complete event.
navigation:
  icon: lucide:hash
seo:
  title: Input OTP (QInputOtp)
  description: QInputOtp — a one-time-password field reusing the q-input field vocabulary.
---
...
::prose-show-case
<dnax-demo-input-otp demo="basic"></dnax-demo-input-otp>
...
::prose-show-case
<dnax-demo-input-otp demo="numeric"></dnax-demo-input-otp>
...
::prose-show-case
<dnax-demo-input-otp demo="grouped"></dnax-demo-input-otp>
...
::prose-show-case
<dnax-demo-input-otp demo="masked"></dnax-demo-input-otp>
...
::prose-show-case
<dnax-demo-input-otp demo="states"></dnax-demo-input-otp>
...
::prose-show-case
<dnax-demo-input-otp demo="complete"></dnax-demo-input-otp>
...
<dnax-api name="QInputOtp"></dnax-api>
