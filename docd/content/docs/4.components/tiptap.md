---
title: Tiptap
description: A full-featured rich text editor (Tiptap v3) with a built-in toolbar,
  bubble menu, drag handle, table of contents and mentions.
navigation:
  icon: lucide:pen-line
seo:
  title: Tiptap (QTiptap)
  description: QTiptap — a rich text editor bound to HTML with v-model, toolbar,
    bubble menu, drag handle, TOC and mentions.
---
