---
title: Accordion
description: Collapsible sections — a container, items, triggers and animated
  content, with one or several sections open at once.
navigation:
  icon: lucide:list-collapse
seo:
  title: Accordion (QAccordion)
  description: QAccordion — collapsible sections with items, triggers and animated content.
---
...
::prose-show-case
<dnax-demo-accordion demo="single"></dnax-demo-accordion>
...
::prose-show-case
<dnax-demo-accordion demo="multiple"></dnax-demo-accordion>
...
<dnax-api name="QAccordion"></dnax-api>
...
<dnax-api name="QAccordionItem"></dnax-api>
...
<dnax-api name="QAccordionTrigger"></dnax-api>
...
<dnax-api name="QAccordionContent"></dnax-api>
