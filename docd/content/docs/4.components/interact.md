---
title: Interact
description: A container of draggable, resizable widgets with grid snapping and
  Power BI-style dashboard layout helpers.
navigation:
  icon: lucide:layout-dashboard
seo:
  title: Interact (QInteract)
  description: QInteract — draggable, resizable widgets with grid snapping.
---
