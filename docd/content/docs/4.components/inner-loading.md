---
title: Inner Loading
description: An overlay spinner shown inside a container while it loads — label,
  size, color, dark overlay and custom icon.
navigation:
  icon: lucide:loader-circle
seo:
  title: Inner Loading (QInnerLoading)
  description: QInnerLoading — an overlay spinner covering a position:relative container.
---
...
::prose-show-case
<dnax-demo-inner-loading demo="basic"></dnax-demo-inner-loading>
...
::prose-show-case
<dnax-demo-inner-loading demo="label"></dnax-demo-inner-loading>
...
::prose-show-case
<dnax-demo-inner-loading demo="dark"></dnax-demo-inner-loading>
...
::prose-show-case
<dnax-demo-inner-loading demo="icon"></dnax-demo-inner-loading>
...
<dnax-api name="QInnerLoading"></dnax-api>
