---
title: Bottom Sheet
description: Open a bottom-anchored panel imperatively from code with
  $q.bottomSheet, with height, rounded, translucent and transition options.
navigation:
  icon: lucide:panel-bottom
seo:
  title: Bottom Sheet ($q.bottomSheet)
  description: $q.bottomSheet — open a bottom sheet imperatively from code (options, controller).
---
