---
title: Page Layout
description: The page content zone — automatic offsets for the surrounding fixed
  bars, plus optional virtual scrolling.
navigation:
  icon: lucide:file-text
seo:
  title: Page Layout (QPage)
  description: QPage — the page content zone, with automatic fixed-bar offsets and virtual scrolling.
---
