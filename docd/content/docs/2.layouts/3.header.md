---
title: Header Layout
description: A top bar for titles and actions — in-flow or fixed, with frosted or
  glass backgrounds and built-in safe-area insets.
navigation:
  icon: lucide:panel-top
seo:
  title: Header Layout (QHeader)
  description: QHeader — a top bar (in-flow or fixed) with translucent and glass backgrounds.
---
