...
> A toggle control with boolean, indeterminate and array models — keyboard-accessible, with per-state icons and any color token.
...
<prose-show-case>
<dnax-demo-checkbox demo="simple">
...
<prose-show-case>
<dnax-demo-checkbox demo="indeterminate">
...
<prose-show-case>
<dnax-demo-checkbox demo="states">
...
<prose-show-case>
<dnax-demo-checkbox demo="layout">
