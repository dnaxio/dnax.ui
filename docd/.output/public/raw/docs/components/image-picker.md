...
> An image selection field with a thumbnail grid, per-tile removal, size/count validation and hint/error slots.
...
<q-image-picker label="Photos" multiple="true" hint="Up to 5 images" :max-files="5">
