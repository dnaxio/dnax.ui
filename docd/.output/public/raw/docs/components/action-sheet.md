...
> An iOS-style sheet that presents a list of options on top of the current screen, with select and cancel events.
...
<prose-show-case>
<dnax-demo-action-sheet demo="options">



</dnax-demo-action-sheet>
...
<prose-show-case>
<dnax-demo-action-sheet demo="events">
