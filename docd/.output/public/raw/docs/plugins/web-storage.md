...
> Type-preserving Web Storage with $q.localStorage and $q.sessionStorage — Quasar-compatible, SSR-safe get/set.
...
<tbody>
  <tr>
    ...
    <td>
      Whether the key exists (alias: hasItem)
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Typed value of the key, or null if absent
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Typed value at the given index (Web Storage order), or null
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Key name at the given index, or null
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      All key names, in storage order
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Stores a value with type serialization (alias: setItem)
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Removes the key (alias: removeItem)
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Empties the whole storage (careful: every key of the origin)
    </td>
  </tr>
