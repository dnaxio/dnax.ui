---
title: Installation
description: Add @dnax/ui to your project and render your first component.
navigation:
  icon: lucide:download
seo:
  title: Installation
  description: Install @dnax/ui, register the Nuxt module and render your first component.
---
...
::prose-show-case
<q-btn color="primary" label="Hello Dnax UI"></q-btn>
