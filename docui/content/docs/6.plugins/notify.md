---
title: Notify
description: Show toast notifications imperatively from code with $q.notify —
  position, type, timeout and action buttons.
navigation:
  icon: lucide:bell
seo:
  title: Notify ($q.notify)
  description: $q.notify — show toasts from anywhere (position, type, timeout, actions).
---
