...
description: The app root — theme tokens (colors, mode, default component props)
  and the programmatic $q providers, mounted once for the whole subtree.
navigation:
  icon: lucide:settings-2
seo:
  title: Config Provider (QConfigProvider)
  description: QConfigProvider — the app root that supplies the theme and mounts the programmatic providers.
---
