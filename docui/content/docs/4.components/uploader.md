---
title: Uploader
description: A file upload zone with thumbnails, a fullscreen preview,
  count/size limits, filters and custom slots.
navigation:
  icon: lucide:upload
seo:
  title: Uploader (QUploader)
  description: QUploader — a file upload zone with thumbnails, limits and custom slots.
---
