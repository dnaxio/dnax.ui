---
title: Tab Panels
description: Animated panels driven by a shared v-model — transitions, animations,
  swipe and lazy rendering.
navigation:
  icon: lucide:layers
seo:
  title: Tab Panels (QTabPanels)
  description: QTabPanels and QTabPanel — animated panels sharing a v-model with
    the tabs.
---
