...
description: A chat transcript pinned to the live edge — auto-scroll, turn
  anchoring, preserved reading position and jump controls.
navigation:
  icon: lucide:messages-square
seo:
  title: Message Scroller (QMessageScroller)
  description: QMessageScroller — keep a chat transcript pinned to the live edge.
---
