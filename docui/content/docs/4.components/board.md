---
title: Board
description: Power BI-style dashboards — tiles laid out on a background grid, with
  drag & resize handled by QInteract.
navigation:
  icon: lucide:layout-dashboard
seo:
  title: Board (QBoard)
  description: QBoard — a Power BI-style dashboard board of grid tiles.
---
...
the **drag & resize**. Widgets are expressed in **grid units** (`column, row,
spanColumns, spanRows`) — ideal for a persistent, responsive, rebuildable layout.
...
::prose-show-case
<dnax-demo-board demo="dashboard"></dnax-demo-board>
