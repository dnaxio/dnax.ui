---
title: Text
description: A paragraph element with multi-line truncation and animated
  transitions — generate, highlight and breathing effects.
navigation:
  icon: lucide:type
seo:
  title: Text (QText)
  description: QText — a text element with multi-line clamping and animated
    transitions (generate, highlight, breathing).
---
