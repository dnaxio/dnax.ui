---
title: Space
description: A flex spacer that fills the remaining space and pushes surrounding
  elements apart.
navigation:
  icon: lucide:move-horizontal
seo:
  title: Space (QSpace)
  description: QSpace — fills the remaining space in a flex container with the Quasar API.
---
...
::prose-show-case
<div class="demo-row">
  <q-btn label="Back" flat></q-btn>
  <q-space></q-space>
  <q-btn label="Save" color="primary" unelevated></q-btn>
</div>
