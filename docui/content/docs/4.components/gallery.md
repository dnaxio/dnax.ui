---
title: Gallery
description: A responsive image grid with single or multiple selection, labels,
  a max-selected limit, hover zoom and a viewer mode.
navigation:
  icon: lucide:layout-grid
seo:
  title: Gallery (QGallery)
  description: QGallery — a responsive image grid with single/multiple selection, labels and a viewer mode.
---
...
::prose-show-case
<dnax-demo-gallery demo="basic"></dnax-demo-gallery>
...
::prose-show-case
<dnax-demo-gallery demo="multiple"></dnax-demo-gallery>
...
::prose-show-case
<dnax-demo-gallery demo="labels"></dnax-demo-gallery>
...
::prose-show-case
<dnax-demo-gallery demo="custom"></dnax-demo-gallery>
...
::prose-show-case
<dnax-demo-gallery demo="viewer"></dnax-demo-gallery>
...
<dnax-api name="QGallery"></dnax-api>
