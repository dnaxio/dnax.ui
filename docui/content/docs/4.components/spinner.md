---
title: Spinner
description: Loading indicators as crisp SVGs — thirteen types, any size and
  color, plus a thickness for the ring variants.
navigation:
  icon: lucide:loader-circle
seo:
  title: Spinner (QSpinner)
  description: QSpinner — SVG loading indicators with the Quasar API.
---
