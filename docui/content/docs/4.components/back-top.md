---
title: Back Top
description: A sticky floating button that appears after scrolling past an offset
  and smooth-scrolls back to the top.
navigation:
  icon: lucide:arrow-up-to-line
seo:
  title: Back Top (QBackTop)
  description: QBackTop — a sticky back-to-top button with the Quasar API.
---
...
::prose-show-case
<dnax-demo-back-top demo="basic"></dnax-demo-back-top>
...
::prose-show-case
<dnax-demo-back-top demo="positions"></dnax-demo-back-top>
...
::prose-show-case
<dnax-demo-back-top demo="custom"></dnax-demo-back-top>
...
<dnax-api name="QBackTop"></dnax-api>
