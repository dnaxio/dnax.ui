...
export const menuItems: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Bar", link: "/docs/components/bar", export: "QBar" },
      { title: "Board", link: "/docs/components/board", export: "QBoard" },
      { title: "Bottom Sheet", link: "/docs/components/bottom-sheet", export: "QBottomSheet" },
      { title: "Breadcrumbs", link: "/docs/components/breadcrumbs", export: "QBreadcrumbs" },
      { title: "Bubble", link: "/docs/components/bubble", export: "QBubble" },
      { title: "Button", link: "/docs/components/btn", export: "QBtn" },
      { title: "Button Actions", link: "/docs/components/btn-actions", export: "QBtnActions" },
      { title: "Button Dropdown", link: "/docs/components/btn-dropdown", export: "QBtnDropdown" },
      ...
      { title: "Editor.js", link: "/docs/components/editor-js", export: "QEditorJs" },
      ...
      { title: "Interact", link: "/docs/components/interact", export: "QInteract" },
      ...
      { title: "Spreadsheet", link: "/docs/components/spreadsheet", export: "QSpreadsheet" },
      ...
      { title: "Tiptap", link: "/docs/components/tiptap", export: "QTiptap" },
